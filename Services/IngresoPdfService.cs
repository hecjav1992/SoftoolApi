...
public class IngresoPdfService
{
        ...
        container.Page(page =>
        {
            ...
            page.Content()
                ...
                .Column(c =>
                {
                    ...
                    c.Item()
                        .Text(
                            $"INGRESO DE {ingreso.TipoEquipo.Trim().ToUpperInvariant()}"
                        )
                        .FontColor("#0783A0")
                        .Bold();
                    ...
                    if (ingreso.Evidencia is { Length: > 0 })
                    {
                        c.Item()
                            .AlignCenter()
                            .MaxHeight(240)
                            .Image(ingreso.Evidencia)
                            .FitArea();
                    }
                    else
                    {
                    ...
                    c.Item()
                        .PaddingLeft(20)
                        .Text(
                            "El presente documento certifica la recepción del equipo descrito por EASY DATA para evaluación y servicio técnico. Conserve este comprobante para futuras consultas."
                        )
                        .LineHeight(1.35f);
            ...
            page.Footer()
                ...
                {
                    x.Span(
                        "EASY DATA · Capira, Panamá Oeste · Página "
                    );
    ...
    private static void SeccionTitulo(
        ColumnDescriptor c,
        string numero,
        string titulo) =>
